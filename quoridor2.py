...
#player: username, x, y, walls
def playing(game_id, players, preload=None, turn=0) :
    global y
    global x 
    global yw 
    global ys 
    ...
    if preload == None:
        ...
        wall1 = players[0]['walls']
        wall2 = players[1]['walls']
    ...
    while 1 :
            ...
            for line in listc:
                ...
                for i in range(17):
                    if str(line[i]) in ('1', '2'):
                        line[i] = ' '
            players[0]['x'] = x1p
            players[0]['y'] = y1p
            players[0]['walls'] = wall1
            players[1]['x'] = x2p
            players[1]['y'] = y2p
            players[1]['walls'] = wall2
            saving.record_game(game_id, list, players, "unfinished", 0, turn, None)
            #game board
            for i in list :
                    print("".join(i))
            #who won ?
